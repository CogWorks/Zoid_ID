...
def update_feedback_adaptive(trial_counter, wrong_counter,response_time_counter):
	...
	Feedback_Screen.text = feedback+accuracy_message+speed_message+feedback_message+"You will now have a break. Place you hand on X or M keys, press either to continue when you are ready."
