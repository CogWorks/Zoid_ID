...
expName = 'keyNameFinder'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\Song Ye\\Documents\\CogSciLabs\\Cogworks\\ZiodID\\keyNameFinder.psyexp',
...
description = visual.TextStim(win=win, name='description',
    text='This tool helps you find the names of your allowed/correct keys for your experiment.\n\n(Press space to move on, escape to quit)',
    font='Arial',
...
keyNameText = visual.TextStim(win=win, name='keyNameText',
    text='Press any key',
    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
...
descriptionKeyboard = event.BuilderKeyResponse()
# keep track of which components have finished
trialComponents = [ISI, description, descriptionKeyboard]
...
# keep track of which components have finished
keyNameFinderRoutineComponents = [keyNameText]
