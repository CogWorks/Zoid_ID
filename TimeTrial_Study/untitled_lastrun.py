...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\Song Ye\\Documents\\Courses\\CSCI - Operating Systems\\Proj1\\Zoid_ID\\TimeTrial_Study\\untitled.psyexp',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    frameRemains = 0.0 + 100- win.monitorFramePeriod * 0.75  # most of one frame period left
